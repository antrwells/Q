...
namespace Q.Texture
{
    public class TextureCube : Texture
    {
        ...
        public TextureCube(int w, int h)
        {
            ...
            {
                //TextureTarget.
                GL.TexImage2D((TextureTarget)((int)(TextureTarget.TextureCubeMapPositiveX) + i), 0, (int)InternalFormat.Rgb32f, w, h, 0, PixelFormat.Rgb, PixelType.UnsignedByte, IntPtr.Zero);
            }
        }
